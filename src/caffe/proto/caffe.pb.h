...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_SLICE = 34
};
...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_SLICE;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const int kSliceParamFieldNumber = 34;
...
class DataParameter : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 show_data() const;
  inline void set_show_data(::google::protobuf::int32 value);
...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_use_label() const;
  inline void clear_use_label();
  static const int kUseLabelFieldNumber = 15;
  inline bool use_label() const;
  inline void set_use_label(bool value);
...
class AggregationParameter : public ::google::protobuf::Message {
 public:
  ...
  AggregationParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_aggregation_param_r() const;
  inline void clear_aggregation_param_r();
  static const int kAggregationParamRFieldNumber = 1;
  inline float aggregation_param_r() const;
  inline void set_aggregation_param_r(float value);
